    ...
    <table class="table table-bordered">
        ...
        <c:forEach var="hoaDon" items="${danhSachHoaDon}">
            <tr>
                ...
                <td>
                    <a href="/hien-thi-hoa-don/update/${hoaDon.id}" class="btn btn-warning btn-sm">Sửa</a>
                    <a href="/hien-thi-hoa-don/delete?id=${hoaDon.id}" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa không?');">Xóa</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>

...
public class HoaDonChiTietController {
    ...
    public String deleteHoaDonChiTiet(@RequestParam("id") Integer id) {
        ...
        return "redirect:/hien-thi-hoa-don-chi-tiet"; // Chuyển hướng về danh sách sau khi xóa
    }
